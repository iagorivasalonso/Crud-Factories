...
Future<List<Empleoyee>> csvImportEmployee({
  ...
  if (bytes != null) {
    ...
    // 🟢 3. DESKTOP → usar como archivo real
  ...
  return readEmployeeFromCsvContent(csvContent);
}

List<Empleoyee> readEmployeeFromCsvContent(String content) {
  final lines = const LineSplitter()
      .convert(content)
      .where((line) => line.trim().isNotEmpty)
      .toList();

  final employees = <Empleoyee>[];
