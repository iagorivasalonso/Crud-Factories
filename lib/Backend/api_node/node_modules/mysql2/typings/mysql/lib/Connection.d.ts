...
export interface ConnectionOptions {
  ...
  /**
   * Name of the config.database to use for this connection
   */
  ...
  /**
   * The hostname of the config.database you are connecting to. (Default: localhost)
   */
  host?: string;
  ...
  /**
   * When dealing with big numbers (BIGINT and DECIMAL columns) in the config.database, you should enable this option
   * (Default: false)
   */
